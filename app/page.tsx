...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      <section className="section">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h2 className="text-heading-1 font-heading">Best Sellers</h2>
          </div>
      ...
      <section className="section bg-charcoal-light">
        <div className="container">
          <div className="text-center mb-12">
            <p className="text-gold text-sm uppercase tracking-widest mb-2">
              Find Your Perfect Match
            </p>
            <h2 className="text-heading-1 font-heading">Shop By Texture</h2>
          </div>
      ...
      <section className="section">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h2 className="text-heading-1 font-heading">Shop By Length</h2>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {['10"', '12"', '14"', '16"', '18"', '20"', '22"', '24"'].map((length) => (
              <Link
                ...
                className="group relative aspect-square overflow-hidden rounded-lg border border-silver/20 hover:border-gold transition-colors"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-charcoal-light to-charcoal" />
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-heading-2 font-heading text-gold group-hover:scale-110 transition-transform">
                    {length}
                  </span>
                </div>
              </Link>
      ...
      <section className="section bg-charcoal-light">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h2 className="text-heading-1 font-heading">See It On Real Customers</h2>
          </div>
      ...
      <section className="section">
        <div className="container max-w-2xl text-center">
          <h2 className="text-heading-2 font-heading mb-4">
            Stay In The Loop
          </h2>
